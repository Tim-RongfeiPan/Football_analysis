...
# like this /home/skovorodkin/stack/scripts
...
if feature_type == "deep":
    deep_database_directory = current_directory + \
        "/data_2/features/feature_camera_91k.mat"
    ...
    HOG_database_directory = current_directory + \
        "/data_2/features/database_camera_feature_HoG.mat"
...
if address_args.advertising_image:
    ...
    im_out_2 = cv.warpPerspective(
        billboard, refined_h, (1280, 720), borderMode=cv.BORDER_CONSTANT)
